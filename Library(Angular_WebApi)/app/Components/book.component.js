...
var BookComponent = (function () {
    ...
    BookComponent.prototype.ngOnInit = function () {
        this.bookFrm = this.fb.group({
            ...
            Author: [''],
            Publisher: ['', forms_1.Validators.required],
    ...
    BookComponent.prototype.readBook = function (id) {
        this.dbops = enum_1.DBOperation.read;
        this.SetControlsState(false);
    ...
    BookComponent.prototype.onSubmit = function (formData) {
        ...
        switch (this.dbops) {
            ...
            case enum_1.DBOperation.update:
                ...
                break;
            case enum_1.DBOperation.read:
                this._bookService.read(global_1.Global.BASE_BOOK_ENDPOINT, formData._value.Id).subscribe(function (data) {
                    if (data == 1) {
                        _this.msg = "Data successfully got.";
                        _this.LoadBooks();
                    }
                    else {
                        _this.msg = "There is some issue in get data, please contact to system administrator!";
                    }
                    _this.modal.dismiss();
                }, function (error) {
                    _this.msg = error;
